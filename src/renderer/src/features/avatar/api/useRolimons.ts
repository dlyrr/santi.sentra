...
> = {
  ...
  sword_fighting_champion: {
    ...
    description:
      "Win a Rolimon's sword fighting tournament hosted in our Discord server",
  ...
  value_100k: {
    label: "100K+",
    description:
      "Own an inventory of limiteds worth at least one hundred thousand total value",
    color: "text-emerald-400",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  value_500k: {
    label: "500K+",
    description:
      "Own an inventory of limiteds worth at least five hundred thousand total value",
    color: "text-emerald-400",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  value_1m: {
    label: "1M+",
    description:
      "Own an inventory of limiteds worth at least one million total value",
    color: "text-emerald-400",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  value_5m: {
    label: "5M+",
    description:
      "Own an inventory of limiteds worth at least five million total value",
    color: "text-emerald-400",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  value_10m: {
    label: "10M+",
    description:
      "Own an inventory of limiteds worth at least ten million total value",
    color: "text-emerald-400",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  value_20m: {
    label: "20M+",
    description:
      "Own an inventory of limiteds worth at least twenty million total value",
    color: "text-emerald-400",
    bgColor: "bg-emerald-500/10",
    borderColor: "border-emerald-500/20",
  },
  value_100m: {
    label: "100M+ Value",
    description:
      "Own an inventory of limiteds worth at least one hundred million total value",
    color: "text-yellow-400",
    bgColor: "bg-yellow-500/10",
    borderColor: "border-yellow-500/20",
  },
  value_1b: {
    label: "1B+ Value",
    description:
      "Own an inventory of limiteds worth at least one billion total value",
    color: "text-yellow-400",
    bgColor: "bg-yellow-500/10",
    borderColor: "border-yellow-500/20",
  },
  ...
  own_epic_katana_set: {
    ...
    description:
      "Own the epic katana set (Blue, Crimson, Golden, Iris, Jade, Ocherous)",
    color: "text-red-400",
  ...
  own_5_noob: {
    label: "Noob",
    description:
      "Own 5 noob items (Noob Attacks, Noob Assists, Pocket Pals, Bag O' Noobs)",
    color: "text-cyan-400",
    bgColor: "bg-cyan-500/10",
    borderColor: "border-cyan-500/20",
  },
  own_15_noob: {
    label: "Noobie",
    description:
      "Own 15 noob items (Noob Attacks, Noob Assists, Pocket Pals, Bag O' Noobs)",
    color: "text-cyan-400",
    bgColor: "bg-cyan-500/10",
    borderColor: "border-cyan-500/20",
  },
  ...
  own_10_pct_of_1_item: {
    ...
    description:
      "Own 10% of an item's available copies (item must have 2+ available copies)",
    color: "text-lime-400",
  ...
  own_25_pct_of_1_item: {
    ...
    description:
      "Own 25% of an item's available copies (item must have 2+ available copies)",
    color: "text-lime-400",
    bgColor: "bg-lime-500/10",
    borderColor: "border-lime-500/20",
  },
  own_50_pct_of_1_item: {
    ...
    description:
      "Own 50% of an item's available copies (item must have 2+ available copies)",
    color: "text-lime-400",
    bgColor: "bg-lime-500/10",
    borderColor: "border-lime-500/20",
  },
  own_all_asset_types: {
    label: "Accessorized",
    description:
      "Own a limited from each asset type (Hat, Face, Gear, Hair Accessory, etc.)",
    color: "text-sky-400",
...
async function fetchRolimonsItemDetails(): Promise<RolimonsApiResponse> {
  ...
  if (!parsed.success) {
    console.warn(
      "[fetchRolimonsItemDetails] Validation warning:",
      parsed.error.issues,
    );
  }
...
export function getRolimonsItem(
  ...
  const data = queryClient.getQueryData<RolimonsApiResponse>(
    queryKeys.rolimons.itemDetails(),
  );
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<RolimonsPlayerData | null> => {
      ...
      try {
        ...
        if (!parsed.success) {
          console.warn(
            "[useRolimonsPlayer] Validation warning:",
            parsed.error.issues,
          );
        }
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<RolimonsItemPageData | null> => {
      ...
      try {
        ...
        if (!parsed.success) {
          console.warn(
            "[useRolimonsItemPage] Validation warning:",
            parsed.error.issues,
          );
        }
