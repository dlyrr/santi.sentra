  ...
  devtools(
    (set) => ({
      ...
      setCreatorName: (creatorName) =>
        set({ creatorName }, false, "setCreatorName"),
      ...
      setThumbnail: (id, url) =>
        set(
          (state) => ({ thumbnails: { ...state.thumbnails, [id]: url } }),
          false,
          "setThumbnail",
        ),
      setThumbnails: (thumbnails) =>
        set({ thumbnails }, false, "setThumbnails"),
...
export const useCatalogSelectedCategory = () =>
  useCatalogStore((state) => state.selectedCategory);
...
export const useCatalogSortType = () =>
  useCatalogStore((state) => state.sortType);
export const useSetCatalogSortType = () =>
  useCatalogStore((state) => state.setSortType);
export const useCatalogSalesTypeFilter = () =>
  useCatalogStore((state) => state.salesTypeFilter);
export const useSetCatalogSalesTypeFilter = () =>
  useCatalogStore((state) => state.setSalesTypeFilter);
export const useCatalogUnavailableItems = () =>
  useCatalogStore((state) => state.unavailableItems);
export const useSetCatalogUnavailableItems = () =>
  useCatalogStore((state) => state.setUnavailableItems);
export const useCatalogMinPrice = () =>
  useCatalogStore((state) => state.minPrice);
export const useSetCatalogMinPrice = () =>
  useCatalogStore((state) => state.setMinPrice);
export const useCatalogMaxPrice = () =>
  useCatalogStore((state) => state.maxPrice);
export const useSetCatalogMaxPrice = () =>
  useCatalogStore((state) => state.setMaxPrice);
export const useCatalogCreatorName = () =>
  useCatalogStore((state) => state.creatorName);
export const useSetCatalogCreatorName = () =>
  useCatalogStore((state) => state.setCreatorName);
export const useCatalogAppliedMinPrice = () =>
  useCatalogStore((state) => state.appliedMinPrice);
export const useSetCatalogAppliedMinPrice = () =>
  useCatalogStore((state) => state.setAppliedMinPrice);
export const useCatalogAppliedMaxPrice = () =>
  useCatalogStore((state) => state.appliedMaxPrice);
...
export const useCatalogThumbnails = () =>
  useCatalogStore((state) => state.thumbnails);
export const useSetCatalogThumbnail = () =>
  useCatalogStore((state) => state.setThumbnail);
export const useSetCatalogThumbnails = () =>
  useCatalogStore((state) => state.setThumbnails);
export const useResetCatalogStore = () =>
  useCatalogStore((state) => state.reset);
export const useClearCatalogFilters = () =>
  useCatalogStore((state) => state.clearFilters);
