  ...
  try {
    switch (message.type) {
      ...
      case "INIT_ROLIMONS": {
        ...
        rolimonsReady = true;
        const response: WorkerResponse = {
          type: "ROLIMONS_INDEXED",
          count: rolimonsItems.size,
        };
        self.postMessage(response);
        break;
      }
      ...
      case "SEARCH_CATALOG": {
        ...
        const searchResults = catalogNameIndex.search(
          message.query,
          maxResults,
        );
      ...
      case "SEARCH_ROLIMONS": {
        ...
        const acronymResults = rolimonsAcronymIndex.search(
          message.query,
          maxResults,
        );
