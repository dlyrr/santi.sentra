...
export const generatorApi = {
  generateAccountData: () =>
    invoke("generator:generate-account-data", accountDataSchema),
  createAccount: () => invoke("generator:create-account", createAccountSchema),
  createAccountWithUsername: (username: string) =>
    invoke(
  ...
  submitForm: () =>
    invoke(
      "generator:submit-form",
      z.object({ success: z.boolean(), error: z.string().optional() }),
    ),
  closeBrowser: () =>
    invoke(
      "generator:close-browser",
      z.object({ success: z.boolean(), error: z.string().optional() }),
    ),
  generateAndSignup: () =>
    invoke("generator:generate-and-signup", accountDataSchema),
  ...
  deleteAccount: (accountId: string) =>
    invoke("generator:delete-account", successSchema, accountId),
  updateConfig: (config: any) =>
    invoke("generator:update-config", configSchema, config),
  getConfig: () => invoke("generator:get-config", configSchema),
  getPassword: (accountId: string) =>
    invoke(
      "generator:get-password",
      z.object({ success: z.boolean(), password: z.string() }),
      accountId,
    ),
  getCookie: (accountId: string) =>
    invoke(
      "generator:get-cookie",
      z.object({ success: z.boolean(), cookie: z.string() }),
      accountId,
    ),
  ...
  sniperRemoveAccount: (accountId: string) =>
    invoke("sniper:remove-account", successSchema, accountId),
  sniperMoveToMain: (accountId: string) =>
    invoke("sniper:move-to-main", successSchema, accountId),
};
