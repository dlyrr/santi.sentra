...
export const useSelectionStore = create<SelectionStore>()(
  devtools(
    (set) => ({
      ...
      clearSelection: () =>
        set({ selectedIds: new Set() }, false, "clearSelection"),

      selectAll: (ids) =>
        set({ selectedIds: new Set(ids) }, false, "selectAll"),
...
export const useSetSelectedIds = () =>
  useSelectionStore((state) => state.setSelectedIds);
export const useToggleSelection = () =>
  useSelectionStore((state) => state.toggleSelection);
