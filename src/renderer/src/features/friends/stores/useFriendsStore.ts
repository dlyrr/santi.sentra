...
export const useSetFriendsSearchQuery = () =>
  useFriendsStore((state) => state.setSearchQuery);
export const useFriendsScrollPosition = () =>
  useFriendsStore((state) => state.scrollPosition);
export const useSetFriendsScrollPosition = () =>
  useFriendsStore((state) => state.setScrollPosition);
export const useFavoriteFriends = () =>
  useFriendsStore((state) => state.favorites);
export const useToggleFavoriteFriend = () =>
  useFriendsStore((state) => state.toggleFavorite);
export const useResetFriendsStore = () =>
  useFriendsStore((state) => state.reset);
