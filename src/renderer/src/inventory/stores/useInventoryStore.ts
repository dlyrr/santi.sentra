...
export const useInventoryStore = create<InventoryStore>()(
  devtools(
    (set, get) => ({
      ...
      reset: () =>
        set({ ...initialState, fetchedIds: new Set() }, false, "reset"),
...
export const useInventorySortOrder = () =>
  useInventoryStore((state) => state.sortOrder);
export const useSetInventorySortOrder = () =>
  useInventoryStore((state) => state.setSortOrder);
export const useInventorySearchQuery = () =>
  useInventoryStore((state) => state.searchQuery);
export const useSetInventorySearchQuery = () =>
  useInventoryStore((state) => state.setSearchQuery);
export const useInventoryThumbnails = () =>
  useInventoryStore((state) => state.thumbnails);
export const useSetInventoryThumbnails = () =>
  useInventoryStore((state) => state.setThumbnails);
export const useMarkInventoryAsFetched = () =>
  useInventoryStore((state) => state.markAsFetched);
export const useInventoryIsFetched = () =>
  useInventoryStore((state) => state.isFetched);
export const useResetInventoryStore = () =>
  useInventoryStore((state) => state.reset);
export const useClearInventoryFilters = () =>
  useInventoryStore((state) => state.clearFilters);
