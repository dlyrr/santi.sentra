...
export const CatalogItemCard = memo(
  ({
    item,
    thumbnailUrl,
    index,
    ...
    return (
      <motion.div
        ...
        className="group relative flex flex-col bg-[var(--color-surface-strong)]/70 border border-[var(--color-border-subtle)] rounded-2xl overflow-hidden cursor-pointer hover:border-[var(--color-border)] hover:shadow-2xl hover:shadow-black/40 hover:-translate-y-1 transition-all duration-300 text-[var(--color-text-secondary)] backdrop-blur-sm"
      >
        {}
        <div
