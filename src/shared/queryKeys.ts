...
export const queryKeys = {
  ...
  accounts: {
    ...
    statuses: (cookies: string[]) =>
      [...queryKeys.accounts.all, "statuses", cookies] as const,
    stats: (cookie: string) =>
      [...queryKeys.accounts.all, "stats", cookie] as const,
    voice: (cookie: string) =>
  ...
  settings: {
    ...
    accountsViewMode: () =>
      [...queryKeys.settings.all, "accountsViewMode"] as const,
    avatarRenderWidth: () =>
  ...
  games: {
    ...
    byPlaceIds: (placeIds: string[]) =>
      [...queryKeys.games.all, "byPlaceIds", placeIds] as const,
  ...
  avatar: {
    ...
    current: (accountId: string) =>
      [...queryKeys.avatar.all, "current", accountId] as const,
  ...
  userProfile: {
    ...
    platform: (userId: number) =>
      [...queryKeys.userProfile.all, "platform", userId] as const,
    ...
    groups: (userId: number) =>
      [...queryKeys.userProfile.all, "groups", userId] as const,
  ...
  rolimons: {
    ...
    player: (userId: number) =>
      [...queryKeys.rolimons.all, "player", userId] as const,
    itemPage: (itemId: number) =>
  ...
  catalog: {
    ...
    suggestions: (prefix: string) =>
      [...queryKeys.catalog.all, "suggestions", prefix] as const,
  ...
  groups: {
    ...
    userGroups: (userId: number) =>
      [...queryKeys.groups.all, "userGroups", userId] as const,
    pending: (accountId: string) =>
      [...queryKeys.groups.all, "pending", accountId] as const,
    details: (groupId: number) =>
      [...queryKeys.groups.all, "details", groupId] as const,
    roles: (groupId: number) =>
      [...queryKeys.groups.all, "roles", groupId] as const,
    games: (groupId: number) =>
      [...queryKeys.groups.all, "games", groupId] as const,
    socialLinks: (groupId: number) =>
      [...queryKeys.groups.all, "socialLinks", groupId] as const,
    thumbnails: (groupIds: number[]) =>
      [...queryKeys.groups.all, "thumbnails", groupIds] as const,
    wall: (groupId: number) =>
      [...queryKeys.groups.all, "wall", groupId] as const,
  ...
  transactions: {
    ...
    types: (cookie: string) =>
      [...queryKeys.transactions.all, "types", cookie] as const,
