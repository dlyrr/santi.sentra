    ...
    <div className={cn('flex flex-col items-center', className)} onClick={onClick}>
      <div className={cn('flex items-center', gapMap[gap])}>
        ...
        <div
          ...
          style={{
            animation: animated ? 'pulse-subtle 2s ease-in-out infinite' : 'none'
          }}
        />
        ...
        <div
          ...
          style={{
            animation: animated ? 'pulse-subtle 2s ease-in-out infinite 0.3s' : 'none'
          }}
        />
      </div>
      ...
      {options.map((option) => (
        <div
          ...
          className={cn(
            ...
            selected === option.id ? 'scale-110' : 'opacity-70 hover:opacity-100',
            'cursor-pointer'
          )}
          ...
          <div className={cn('flex items-center', gapMap[gap])}>
            ...
            <div
              className={cn(
                ...
                'ring-2 ring-offset-2 ring-offset-neutral-900 ring-opacity-50',
                selected === option.id ? 'ring-2 ring-white' : 'ring-neutral-700'
              )}
              style={{
