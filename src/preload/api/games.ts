...
export const gamesApi = {
  getGameSorts: (sessionId?: string) =>
    invoke("get-game-sorts", z.array(z.any()), sessionId),
  ...
  getRegionFromAddress: (address: string) =>
    invoke("get-region-from-address", z.string(), address),
...
export const groupsApi = {
  ...
  getGroupWallPosts: (groupId: number, cursor?: string, limit?: number) =>
    invoke(
      ...
      S.groupWallPostsResponseSchema,
      groupId,
      cursor,
      limit,
    ),
