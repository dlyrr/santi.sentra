...
const PRIVACY_OPTIONS: DropdownOption[] = [
  ...
  { value: "FriendsAndFollowing", label: "Friends & Following" },
  {
    ...
    label: "Friends, Following & Followers",
  },
...
const AccountSettingsTab: React.FC<AccountSettingsTabProps> = ({
  ...
  const updateTheme = useMutation({
    mutationFn: async (themeType: string) => {
      if (!account?.cookie || !accountSettings?.UserId)
        throw new Error("No cookie or userId");
      return window.api.updateTheme(
        account.cookie,
    ...
    <div className="flex flex-col h-full bg-[var(--color-surface)] text-[var(--color-text-secondary)]">
      ...
      <div className="shrink-0 h-[72px] bg-[var(--color-surface-strong)] border-b border-[var(--color-border)] flex items-center justify-between px-6">
        ...
        <div className="text-sm text-[var(--color-text-secondary)]">
          {accountSettings && (
            <span
              className={`flex items-center gap-2 ${privacyMode ? "privacy-blur" : ""}`}
            >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <SettingRow label="User ID">
                        <span
                          ...
                          style={
                            privacyMode ? { filter: "blur(16px)" } : undefined
                          }
                        >
                          {accountSettings.UserId}
                        </span>
                          ...
                          {editingDescription !== null &&
                            editingDescription !==
                              ...
                              <>
                                <button
                                  onClick={() =>
                                    updateDescription.mutate(editingDescription)
                                  }
                    ...
                    >
                      ...
                      <SettingRow label="Birthdate Locked">
                        <SettingBadge
                          enabled={accountSettings.IsBirthdateLocked}
                        />
                      </SettingRow>
                    </SettingCard>
                    ...
                    >
                      ...
                      <SettingRow label="Email Verified">
                        <div className="flex items-center gap-2">
                          <SettingBadge
                            ...
                            label={
                              accountSettings.IsEmailVerified
                                ? "Verified"
                                : "Not Verified"
                            }
                          />
                          {!accountSettings.IsEmailVerified &&
                            accountSettings.IsEmailOnFile && (
                              <button
                      ...
                      <SettingRow label="Phone Feature">
                        <SettingBadge
                          enabled={accountSettings.IsPhoneFeatureEnabled}
                        />
                      </SettingRow>
                    </SettingCard>
                    ...
                    >
                      <SettingRow label="Account Age">
                        <SettingValue
                          value={formatDays(accountSettings.AccountAgeInDays)}
                        />
                      </SettingRow>
                    ...
                    >
                      ...
                      <SettingRow label="Display Names">
                        <SettingBadge
                          enabled={accountSettings.IsDisplayNamesEnabled}
                        />
                      </SettingRow>
                    </SettingCard>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <SettingRow label="Inventory">
                        <CustomDropdown
                          value={
                            userSettings.whoCanSeeMyInventory?.currentValue ||
                            "NoOne"
                          }
                          options={PRIVACY_OPTIONS}
                          onChange={(v) =>
                            updateInventoryPrivacy.mutate(v as PrivacyLevel)
                          }
                      ...
                      <SettingRow label="Online Status">
                        <CustomDropdown
                          value={
                            userSettings.whoCanSeeMyOnlineStatus
                              ?.currentValue || "Friends"
                          }
                          options={ONLINE_STATUS_PRIVACY_OPTIONS}
                          onChange={(v) =>
                            updateOnlineStatusPrivacy.mutate(
                              v as OnlineStatusPrivacy,
                            )
                          }
                      ...
                      <SettingRow label="Who can join me?">
                        <CustomDropdown
                          value={
                            userSettings.whoCanJoinMeInExperiences
                              ?.currentValue || "Friends"
                          }
                          options={PRIVACY_OPTIONS}
                          onChange={(v) =>
                            updateWhoCanJoinMeInExperiences.mutate(
                              v as PrivacyLevel,
                            )
                          }
                      ...
                      <SettingRow label="Social Networks">
                        <SettingValue
                          value={
                            userSettings.whoCanSeeMySocialNetworks
                              ?.currentValue || "NoOne"
                          }
                        />
                      </SettingRow>
                    ...
                    >
                      <SettingRow label="Phone Discoverability">
                        <CustomDropdown
                          value={
                            userSettings.phoneNumberDiscoverability
                              ?.currentValue === "Discoverable"
                              ? "AllUsers"
                              : "NoOne"
                          }
                          options={PRIVACY_OPTIONS.slice(0, 2)}
                          onChange={(v) =>
                            updatePhoneDiscovery.mutate(v as PrivacyLevel)
                          }
                      ...
                      <SettingRow label="Friend Suggestions">
                        <SettingBadge
                          enabled={
                            userSettings.friendSuggestions?.currentValue ===
                            "Enabled"
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Update Friends About Activity">
                        <SettingBadge
                          enabled={
                            userSettings.updateFriendsAboutMyActivity
                              ?.currentValue === "Yes"
                          }
                          label={
                            userSettings.updateFriendsAboutMyActivity
                    ...
                    >
                      ...
                      <SettingRow label="Private Server Privacy">
                        <SettingValue
                          value={
                            userSettings.privateServerPrivacy?.currentValue ||
                            "AllUsers"
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Party Invite (1:1)">
                        <SettingValue
                          value={
                            userSettings.whoCanOneOnOnePartyWithMe
                              ?.currentValue || "Friends"
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Group Party">
                        <SettingValue
                          value={
                            userSettings.whoCanGroupPartyWithMe?.currentValue ||
                            "Friends"
                          }
                        />
                      </SettingRow>
                    ...
                    >
                      ...
                      <SettingRow label="Who Can Trade">
                        <CustomDropdown
                          value={
                            userSettings.whoCanTradeWithMe?.currentValue ||
                            "NoOne"
                          }
                          options={TRADE_PRIVACY_OPTIONS}
                          onChange={(v) =>
                            updateTradePrivacy.mutate(v as TradePrivacy)
                          }
                      ...
                      <SettingRow label="Trade Quality Filter">
                        <CustomDropdown
                          value={
                            userSettings.tradeQualityFilter?.currentValue ||
                            "None"
                          }
                          options={TRADE_VALUE_OPTIONS}
                          onChange={(v) =>
                            updateTradeValue.mutate(v as TradeValue)
                          }
                      ...
                      <SettingRow label="Purchases">
                        <SettingBadge
                          enabled={
                            userSettings.enablePurchases?.currentValue ===
                            "Enabled"
                          }
                        />
                      </SettingRow>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <SettingRow label="App Chat">
                        <CustomDropdown
                          value={
                            userSettings.whoCanChatWithMeInApp?.currentValue ||
                            "Friends"
                          }
                          options={PRIVACY_OPTIONS}
                          onChange={(v) =>
                            updateAppChatPrivacy.mutate(v as PrivacyLevel)
                          }
                      ...
                      <SettingRow label="Game Chat">
                        <CustomDropdown
                          value={
                            userSettings.whoCanChatWithMeInExperiences
                              ?.currentValue || "AllUsers"
                          }
                          options={PRIVACY_OPTIONS}
                          onChange={(v) =>
                            updateGameChatPrivacy.mutate(v as PrivacyLevel)
                          }
                      ...
                      <SettingRow label="Whisper Chat">
                        <SettingValue
                          value={
                            userSettings.whoCanWhisperChatWithMeInExperiences
                              ?.currentValue || "AllUsers"
                          }
                        />
                      </SettingRow>
                    ...
                    >
                      ...
                      {userSettings.doNotDisturbTimeWindow && (
                        <SettingRow label="Time Window">
                          <span className="text-sm text-[var(--color-text-secondary)]">
                            {formatTimeWindow(
                              userSettings.doNotDisturbTimeWindow.currentValue
                                .startTimeMinutes,
                              userSettings.doNotDisturbTimeWindow.currentValue
                                .endTimeMinutes,
                            )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <SettingRow label="Toggle Available">
                        <SettingBadge
                          enabled={accountSettings.IsTwoStepToggleEnabled}
                        />
                      </SettingRow>
                      <SettingRow label="2FA for Password Change">
                        <SettingBadge
                          enabled={
                            accountSettings.ChangePasswordRequiresTwoStepVerification
                          }
                        />
                      </SettingRow>
                      <SettingRow label="2FA for Email Change">
                        <SettingBadge
                          enabled={
                            accountSettings.ChangeEmailRequiresTwoStepVerification
                          }
                        />
                      </SettingRow>
                    </SettingCard>
                    ...
                    >
                      ...
                      <SettingRow label="Account Restrictions">
                        <SettingBadge
                          enabled={
                            accountSettings.IsAccountRestrictionsFeatureEnabled
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Parental Spend Controls">
                        <SettingBadge
                          enabled={
                            accountSettings.IsParentalSpendControlsEnabled
                          }
                        />
                      </SettingRow>
                    ...
                    >
                      ...
                      <SettingRow label="Valid Password">
                        <SettingBadge
                          enabled={accountSettings.HasValidPasswordSet}
                        />
                      </SettingRow>
                      <SettingRow label="Bound Auth Token">
                        <SettingBadge
                          enabled={
                            userSettings.boundAuthTokenValidation
                              ?.currentValue === "Enabled"
                          }
                        />
                      </SettingRow>
                    ...
                    >
                      <SettingRow label="Third-Party Apps">
                        <SettingBadge
                          enabled={
                            userSettings.allowThirdPartyAppPermissions
                              ?.currentValue === "Enabled"
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Voice Data Usage">
                        <SettingBadge
                          enabled={
                            userSettings.allowVoiceDataUsage?.currentValue ===
                            "Enabled"
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Facial Age Estimation">
                        <SettingBadge
                          enabled={
                            userSettings.allowFacialAgeEstimation
                              ?.currentValue === "Enabled"
                          }
                        />
                      </SettingRow>
                      <SettingRow label="Fast Track">
                        <SettingBadge
                          enabled={accountSettings.IsFastTrackAccessible}
                        />
                      </SettingRow>
                    </SettingCard>
                  </div>
