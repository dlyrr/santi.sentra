            ...
            <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col">
                ...
                <DialogBody className="overflow-y-auto pr-2">
                    <div className="space-y-6 text-[var(--color-text-secondary)]">
                        <div>
                            <p className="text-sm text-[var(--color-text-secondary)] mb-4">Last Updated: December 2025</p>
                        ...
                        <section className="space-y-3">
                            <h3 className="text-[var(--color-text-primary)] font-semibold text-lg">1. Data Collection</h3>
                            ...
                            <ul className="list-disc pl-5 space-y-2 text-sm text-[var(--color-text-secondary)]">
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">No Personal Data Collection:</strong> We do
                                    not track your usage, collect personal identifiers, or store your browsing history
                                    on any remote servers controlled by us.
                                </li>
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">Local Storage:</strong> All sensitive data,
                                    including your account cookies, authentication tokens, settings, and logs, are
                                    stored securely on your local device.
                                </li>
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">Direct Communication:</strong> Sentra
                        ...
                        <section className="space-y-3">
                            <h3 className="text-[var(--color-text-primary)] font-semibold text-lg">2. Third-Party Services</h3>
                            <p className="text-sm leading-relaxed">
                            ...
                            <ul className="list-disc pl-5 space-y-2 text-sm text-[var(--color-text-secondary)]">
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">Roblox:</strong> When you log in or launch
                                ...
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">GitHub:</strong> We use GitHub's API to check
                                    for application updates. This may expose your IP address to GitHub when checking
                                    for updates.
                                </li>
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">Google Fonts:</strong> We may load fonts from
                        ...
                        <section className="space-y-3">
                            <h3 className="text-[var(--color-text-primary)] font-semibold text-lg">3. Security</h3>
                            <p className="text-sm leading-relaxed">
                                We implement local security measures to protect your data.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-sm text-[var(--color-text-secondary)]">
                                <li>
                                    <strong className="text-[var(--color-text-primary)]">Encryption:</strong> Sensitive account data
                        ...
                        <section className="space-y-3">
                            <h3 className="text-[var(--color-text-primary)] font-semibold text-lg">4. Contact Us</h3>
                                <p className="text-sm leading-relaxed">
