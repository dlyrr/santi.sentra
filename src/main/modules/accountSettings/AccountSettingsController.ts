...
export const registerAccountSettingsHandlers = (): void => {
  ...
  handle(
    ...
    async (_, cookie, privacyLevel) => {
      return AccountSettingsService.updateInventoryPrivacy(
        cookie,
        privacyLevel,
      );
    },
  ...
  handle(
    ...
    async (_, cookie, appChatPrivacy) => {
      return AccountSettingsService.updateAppChatPrivacy(
        cookie,
        appChatPrivacy,
      );
    },
  ...
  handle(
    ...
    async (_, cookie, gameChatPrivacy) => {
      return AccountSettingsService.updateGameChatPrivacy(
        cookie,
        gameChatPrivacy,
      );
    },
  ...
  handle(
    ...
    async (_, cookie, contentRestrictionLevel) => {
      return AccountSettingsService.updateContentRestriction(
        cookie,
  ...
  handle(
    ...
    async (_, cookie, onlineStatusPrivacy) => {
      return AccountSettingsService.updateOnlineStatusPrivacy(
        cookie,
        onlineStatusPrivacy,
      );
    },
  ...
  handle(
    ...
    async (_, cookie, birthMonth, birthDay, birthYear) => {
      return AccountSettingsService.updateBirthdate(
        cookie,
        birthMonth,
        birthDay,
        birthYear,
  ...
  handle(
    ...
    async (_, cookie, userId, newDisplayName) => {
      return AccountSettingsService.updateDisplayName(
        cookie,
        userId,
        newDisplayName,
      );
