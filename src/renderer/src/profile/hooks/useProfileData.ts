...
export const useProfileData = ({
  ...
  const profile = useMemo(() => {
    ...
    return {
      ...
      friendCount:
        profilePlatform?.friendsCount || initialData?.friendCount || 0,
      followerCount:
        profilePlatform?.followersCount || initialData?.followerCount || 0,
      followingCount:
        profilePlatform?.followingsCount || initialData?.followingCount || 0,
