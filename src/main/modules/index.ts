...
export type {
  ...
  MacroPlaybackConfig,
  MacroPlaybackResult,
} from "./macro/types/MacroTypes";
export type {
  IMacroRecorder,
  IMacroPlayer,
  IMacroService,
} from "./macro/interfaces/MacroInterfaces";
...
} from "./trading/interfaces/TradingInterfaces";
...
export type {
  IBrowserService,
  IFormAutomationService,
  IBrowserAutomationService,
} from "./browser/interfaces/BrowserInterfaces";
...
export type {
  ...
  IProxyPool,
  IProxyManager,
} from "./proxy/interfaces/ProxyInterfaces";
