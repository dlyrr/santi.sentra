  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-md w-full animate-in zoom-in-95 fade-in duration-500 mx-auto mt-20">
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-6 p-12 bg-[var(--color-surface-strong)]/80 backdrop-blur-xl border-2 border-dashed border-[var(--color-border)] group-hover:border-[var(--accent-color)]/50 rounded-3xl transition-all duration-300 hover:shadow-[0_0_40px_var(--accent-color-faint)]">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-[var(--color-text-secondary)] max-w-[250px] mx-auto leading-relaxed">
              Paste your Roblox `.ROBLOSECURITY` cookie anywhere, or click here
          ...
          <Button
            variant="default"
            size="lg"
            className="w-full font-bold shadow-[0_0_20px_var(--accent-color-faint)] mt-2"
          >
