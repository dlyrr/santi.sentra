  ...
  const robuxBalance = useMemo(() => {
    if (selectedAccounts.length > 1) {
      return selectedAccounts.reduce(
        (total, acc) => total + (acc.robuxBalance || 0),
        0,
      );
    }
        ...
        <>
          <div className="relative" ref={containerRef}>
            <button
              ...
              className={`h-10 flex items-center gap-0 border transition-all duration-200 group ${
                isDropdownOpen
                  ...
                  <div className="p-1.5">
                    {dropdownGroups.map((group, groupIndex) => (
                      <div
                        ...
                        className={
                          groupIndex > 0
                            ? "mt-1 pt-1 border-t border-[var(--color-border)]"
                            : ""
                        }
                      >
    ...
    <div className="px-3 py-3 relative" ref={containerRef}>
      ...
      <button
        ...
        className={`w-full rounded-xl border transition-all duration-200 text-left ${
          isDropdownOpen
            ? "border-[var(--accent-color-border)] bg-gradient-to-br from-[var(--accent-color-faint)] to-transparent shadow-[0_0_15px_var(--accent-color-faint)]"
            : "border-[var(--color-border)] bg-[var(--color-surface-muted)] hover:bg-[var(--color-surface-hover)] hover:border-[var(--color-border-strong)]"
        }`}
      >
        <div className="p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0 px-2 py-0.5 rounded-md bg-[var(--color-surface-muted)] border border-[var(--color-border)] shadow-sm group-hover:border-[var(--color-border-strong)] transition-colors">
