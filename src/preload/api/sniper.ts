...
const usernamesListSchema = z.object({
  success: z.boolean(),
...
export const sniperApi = {
  ...
  getLimitedWatches: () => invoke("sniper:get-limited-watches", watchesSchema),
