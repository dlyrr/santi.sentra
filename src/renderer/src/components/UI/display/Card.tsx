...
>(({ className, selected, disableHover, variant = "default", ...props }, ref) => {
  const variantStyles = {
    default: "bg-[var(--color-surface-strong)] border-[var(--color-border-subtle)]",
    ghost: "bg-transparent border-transparent shadow-none",
    account: "bg-[var(--color-surface)] border-[var(--color-border-subtle)] overflow-hidden p-0",
  };
