            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 max-h-[250px] overflow-y-auto scrollbar-thin pr-2 bg-[var(--color-surface)]/50 p-2 rounded-lg border border-[var(--color-border)]/50">
                  ...
                  {Object.entries(fflags).map(([key, val]) => (
                    <div
                      key={key}
                      className="flex items-center gap-2 bg-[var(--color-app-bg)] p-3 rounded-lg border border-[var(--color-border)] group"
                    >
                      <Tooltip>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    className="flex-1 bg-[var(--color-app-bg)] border border-[var(--color-border)] rounded-lg px-3 py-2.5 text-sm text-[var(--color-text-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-color)] font-mono placeholder:font-sans"
                    placeholder="Flag Name"
                    value={newFlagKey}
                    onChange={(e) => setNewFlagKey(e.target.value)}
                  />
                  <input
                    className="w-28 bg-[var(--color-app-bg)] border border-[var(--color-border)] rounded-lg px-3 py-2.5 text-sm text-[var(--color-text-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--accent-color)] font-mono placeholder:font-sans"
                    placeholder="Value"
                    value={newFlagValue}
