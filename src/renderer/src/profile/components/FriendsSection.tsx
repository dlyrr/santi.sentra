          ...
          <div className="flex gap-4 pl-3 pr-3">
            {isLoading ? (
              ...
              friends.map((friend, index) => {
                const friendStatus = mapPresenceToStatus(
                  friend.userPresenceType ?? 0,
                );
                const usernameLabel = friend.username
                  ? `@${friend.username}`
                  : "";
                return (
                  <motion.div
                    ...
                    <div className="text-center w-full">
                      ...
                      <div className="flex items-center justify-center gap-1 text-[11px] font-semibold text-[var(--color-text-secondary)] mt-0.5">
                        ...
                        <span className="truncate">
                          {friendStatus === AccountStatus.InGame &&
                          friend.lastLocation
                            ? friend.lastLocation
