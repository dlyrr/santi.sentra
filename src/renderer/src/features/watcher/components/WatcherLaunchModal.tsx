...
export const WatcherLaunchModal: React.FC<WatcherLaunchModalProps> = ({
  ...
  const [joinMode, setJoinMode] = useState<'public' | 'private' | 'jobid' | 'username'>('public')
      ...
      <DialogContent className="max-w-md">
        ...
        <DialogBody>
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-2">
                ...
                >
                  ...
                  <div className="text-xs text-[var(--color-text-muted)] mt-1">Join a random public server</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-[var(--color-text-muted)] mt-1">Join a specific server by Job ID</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-[var(--color-text-muted)] mt-1">Join with an invite link or code</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-[var(--color-text-muted)] mt-1">Join a user in game by username/ID</div>
                </button>
              </div>
            </div>
            ...
            {joinMode === 'private' && (
              <div className="space-y-2">
                <label className="text-sm font-medium">Private Server Link</label>
                <input
                  type="text"
